...
export function SitePageShell({
  ...
  return (
    <div className="relative flex min-h-0 flex-1 flex-col overflow-hidden">
      ...
      <div className="pointer-events-none absolute -left-32 top-24 h-72 w-72 rounded-full bg-sky-400/20 blur-3xl dark:bg-sky-500/15 home-float-slow" />
      ...
      <div className="pointer-events-none absolute bottom-20 left-1/4 h-48 w-48 rounded-full bg-amber-400/10 blur-2xl dark:bg-amber-500/10 home-float-slow" />
